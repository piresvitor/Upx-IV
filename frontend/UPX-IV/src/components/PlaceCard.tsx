      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <h3 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-1.5 sm:mb-2 line-clamp-2">
              {name}
            </h3>
            {address && (
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 self-center">
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-50 rounded-lg">
              <FileText size={22} className="text-blue-600 sm:w-8 sm:h-8" />
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-red-50 rounded-lg">
              <Heart size={22} className="text-red-600 sm:w-8 sm:h-8" />
              <span className="text-base sm:text-lg font-semibold text-gray-800">
                {votesCount}
              </span>
            </div>
