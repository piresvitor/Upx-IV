      ...
      <div className="grid lg:grid-cols-2 lg:gap-10 gap-5 items-start">
        <div className="w-full flex items-center justify-center">
          {photoUrl ? (
            ...
            <div className="w-full h-64 bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-gray-500 dark:text-gray-300 rounded-2xl">
        ...
        <div className="space-y-5">
          <h1 className="lg:text-2xl text-base font-semibold text-gray-800 dark:text-white">
          ...
          <div className="space-y-1">
            <div className="flex flex-row gap-2">
              ...
              <p className="text-gray-800 dark:text-white mb-2 text-base">
