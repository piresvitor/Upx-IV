...
graph TB
    ...
    subgraph "Core Business Logic Layer"
        ...
        subgraph "Places Management"
            PLACE_SEARCH_TEXT[Search by Text Route<br/>GET /places/search-by-text]
    ...
    PLACE_SEARCH_TEXT --> PLACE_SERVICE
